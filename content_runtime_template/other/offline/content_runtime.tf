...
output "docker_registry_camc_pattern_manager_version" { value = "${local.docker_registry_camc_pattern_manager_version}"}
output "docker_registry_camc_sw_repo_version" { value = "${local.docker_registry_camc_sw_repo_version}"}
